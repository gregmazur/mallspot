...
<body>
	...
	<div class="container">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><span class="glyphicon glyphicon-home"></span>
								Выбор торгового цетра <b class="caret"></b> </a>
		...
		<div class="container">
			<h2>Регистрация</h2>
			<div class="row">
				<form class="form-horizontal" method="post" action="reg.jsp" role="form">
					<div class="form-group">
		...
		<%
			...
			String passwordConfirm = request.getParameter("inputPassword2");
